...
import { createCashierSchema, updateUserSchema, userParamSchema } from '@niaga/shared';
...
export const userController = new Hono<Env>()
  ...
  .patch('/:id', validate('param', userParamSchema), validate('json', updateUserSchema), async (c) =>
